...
工程基础、核心数据模型、CRUD、导航、统计、搜索、多档年度提醒、导出、v1/v2 兼容的普通与密码加密备份恢复、主题切换和设置说明页面均已完成。OCR 已从代码、导航、资源、依赖、权限、测试和文档中移除，应用不再申请联网权限，也不再读取 AI Studio 令牌。

## 后续开发计划

1. 完成 Pixel 9、物理设备、大字体和深色模式的完整易用性走查。
2. 根据真实用户反馈评估农历日期、自定义提醒周期和提醒记录直达能力。
