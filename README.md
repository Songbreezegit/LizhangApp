...
首页、联系人、联系人详情、记一笔、搜索、统计、OCR 导入入口和“我的”页面均已应用统一视觉系统。底部四项主入口调整为“首页 / 联系人 / 记一笔 / 我的”，统计、搜索和 OCR 作为首页快捷流程进入。首页汇总、最近记录、联系人查询、礼金保存和统计聚合使用现有 Repository 数据；OCR、导出、备份恢复等尚未具备底层能力的入口会明确提示仍在完善，不会伪造执行结果。
